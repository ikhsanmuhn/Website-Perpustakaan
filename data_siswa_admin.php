    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="sidebar-sticky">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="data_siswa_admin.php">
                    ...
                    <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#siswa_tambah" style="margin-left:500px; border-radius:50px;">
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            ...
                            <div class="row">
                                    <div class="col-md-12">
                                        <div class="form">
                            <form  method="POST" action="action_siswa_admin.php" enctype="multipart/form-data">
                       ...
                       <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#<?php $formatted_value = "S".sprintf($row['nis']);echo $formatted_value; ?>">
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            ...
                            <div class="row">
                                    <div class="col-md-12">
                                        <div class="form">
                        <form enctype="multipart/form-data" action="action_siswa_admin.php" method="POST">
