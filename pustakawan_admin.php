    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="sidebar-sticky">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="pustakawan_admin.php">
                ...
                <li class="nav-item">
                        ...
                        <a id='data_pustakawan' class='nav-link' href='data_pustakawan_admin.php'>
                        Pustakawan
                        </a>
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
                    ...
                    <form class="form-inline my-2 my-lg-0"  method="GET" action="">
                        <input class="form-control mr-sm-2" type="search" placeholder="Search" name="cari" aria-label="Search" style="border-radius:50px;">
                    ...
                    <td>
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            ...
                            <div class="row">
                                    <div class="col-md-12">
                                        <div class="form">
                        <form method="POST" action="action_transaksi_admin.php" enctype="multipart/form-data">
                                                ...
                                                <?php echo $row['qty'];if($row['qty'] == 1){
                                                      $qw="SELECT dt.idBuku, b.judul FROM buku b, detailtransaksi dt WHERE dt.idBuku=b.idBuku";
                                                      $er=$db->prepare($qw);
                                                      $er->execute();
                        ...
                        <form method="POST" action="action_transaksi_admin.php" enctype="multipart/form-data">
                                                ...
                                                <?php
                                                    while($wow = $er->fetch(PDO::FETCH_ASSOC)){
                                                ?>
                                                <div class="form-group">
                                                    <input type="text" id="id_buku" class="form-control" placeholder="Kode Buku" name="idBuku_transaksi" value="<?php echo $wow['idBuku'];?>">   
                                                    <fieldset disabled><input type="text" id="judul_buku" class="form-control" placeholder="Judul BUku" value="<?php echo $wow['judul'];?>" ></fieldset>
