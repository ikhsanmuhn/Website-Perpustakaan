    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="sidebar-sticky">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="data_pustakawan_admin.php">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
                    ...
                    <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#exampleModalCenter" style="margin-left:400px; border-radius:50px;">
                            Tambah
                        </button>
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            ...
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalCenterTitle">Tambah Data Pustakawa</h5>
                            ...
                            <div class="row">
                                    <div class="col-md-12">
                                        <div class="form">
                        <form  method="POST" action="action_pustakawan.php" enctype="multipart/form-data">
                                                
                                                    <div class="form-group">
                                                            <label for="id_pe">ID Pustakawan</label>
                                                            <input type="text" id="id_p" class="form-control" placeholder="P001" value="<?php echo $_SESSION['id_value_pustakawan'];?>" disabled="disabled">
                                                            <input type="hidden" name="id_tambah" value="<?php $pene = $_SESSION['id_value_pustakawan'];
                                                                echo $pene?>">
                                                    </div>
                                                
                                                <div class="form-group">
                                                        <label for="nama_pe">Nama</label>
                                                        <input type="text" id="nama_pe" name="nama_tambah" class="form-control" placeholder="Nama Pustakawan">
                                                </div>
                                                <div class="form-group">
                ...
                ?>
                    ...
                    <!-- Button trigger modal edit -->
                        <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#<?php echo $row['idPustakawan']; ?>">
                            Edit
                        </button>

                        <!-- Modal -->
                        <div class="modal fade" id="<?php echo $row['idPustakawan']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalCenterTitle">Edit Data Pustakawan</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            ...
                            <form  method="POST" action="action_pustakawan.php" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group">
                                                                <label for="id_pe">ID Pustakawan</label>
                                                                <input type="text" id="id_p" class="form-control" placeholder="P001" value="<?php echo $row['idPustakawan']; ?>" disabled="disabled">
                                                                <input type="hidden" name="id_edit" value="<?php echo $row['idPustakawan']; ?>">
                                                        </div>
                                                    
                                                    <div class="form-group">
                                                            <label for="nama_pe">Nama</label>
                                                            <input type="text" id="nama_pe" name="nama_edit" class="form-control" placeholder="Nama Pustakawan" value="<?php echo $row['nama']; ?>">
                                                    </div>
                                                    <div class="form-group">
                                                            <label for="alamat_pe">Alamat</label>
                                                            <textarea id="alamat_pe" name="alamat_edit" class="form-control" placeholder="Alamat Lengkap"><?php echo $row['alamat']; ?></textarea>
                                                    </div>
                                                    <div class="form-group">
                                                            <label for="telp_pe">No. Telepon</label>
                                                            <input type="text" id="telp_pe" name="telpon_edit" class="form-control" placeholder="Telp" value="<?php echo $row['phone']; ?>">
                                                    </div>
                                                    <div class="form-group">
                                                            <label for="email_pe">Email</label>
                                                            <input type="email" id="email_pe" name="email_edit" class="form-control" placeholder="Email" value="<?php echo $row['email']; ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" class="custom-file-input" id="customFile">    
                                                            ...
                                                            <input type="file" name="photo_edit" class="form-control-file"  value="<?php echo $row['image']; ?>" id="masukanFoto"onchange="document.getElementById('gambar_tambah').src=window.URL.createObjectURL(this.files[0])">
                                                            <img id="gambar_tambah" src="img_upload/<?php echo $row['image']; ?>" height="150" width="100"/>
...
<?php
    require_once "koneksi.php";
    $sql="SELECT idPustakawan FROM pustakawan ORDER BY idPustakawan DESC LIMIT 1";
    $stmt = $db->prepare($sql);
    $stmt->execute();
    ...
    $formatted_value = "P".sprintf("%03d", $angka);
    $_SESSION['id_value_pustakawan'] = $formatted_value;
?>
