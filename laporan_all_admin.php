    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="sidebar-sticky">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item nav-link active" href="laporan_all_admin.php" style="background: none;">All</a>
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
                    <h1 class="h3">Laporan Semua Transaksi</h1>
                </div>
                <?php
            ...
            ?>
                        <div class="col-md-12 d-flex justify-content-center">
                            <h4 style="margin-bottom:30px;">Laporan Transaksi Bulan <?php echo $mm["$bul"];?></h4>
                        </div>
                        <div class="form">
                            <form method="POST" action="">
                                <div class="form-row">
                                    ...
                                    <input type="date" name="start_date" id="start" class="form-control" placeholder="Start Date" date_format="Y-m-d">
                                    </div>
                                    <label for="end" class="col-md-2">End Date</label>
                                    <div class="form-group col-md-3">
                                    <input type="date" id="end" name="end_date" class="form-control" placeholder="End Date">                                    
                                    </div>
